        ...
        public void Update(Room room)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    //Here, we are using a UPDATE statement in our SQL command, what we're really telling the database is simply that:
                    //"We'd like you to execute this SQL code to update a row. We don't expect you to give us anything back, please and thank you".
                    cmd.ExecuteNonQuery();
                }
            }
        }
